...
router.post('/post/opening-tags-entry', async (req, res) => {
  try {
    ...
    const sql = `INSERT INTO opening_tags_entry (
      ...
      Stones_Weight, deduct_st_Wt, Stones_Price, WastageWeight, HUID_No, Wastage_On, Wastage_Percentage,
    ...
    const values = insertEntries.map(entry => [
      ...
      entry.WastageWeight, entry.HUID_No, entry.Wastage_On, entry.Wastage_Percentage, 
